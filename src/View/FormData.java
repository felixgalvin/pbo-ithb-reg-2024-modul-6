    ...
    private void initComponents() {
        ...
        submit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Date tglLahirOutput = tanggalLahir.getDate();

                LocalDate tanggalLahirlocalDate;
                String tanggalLahirlocalDateFormatted = "";
                if (tglLahirOutput != null) {
                    tanggalLahirlocalDate = tglLahirOutput.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
                    tanggalLahirlocalDateFormatted = tanggalLahirlocalDate.format(DateTimeFormatter.ofPattern("dd-MM-yyyy"));
                }
                ...
                LocalDate tglPembuatanLocalDate;
                String tglPembuatanFormatted = "";
                if (tglLahirOutput != null) {
                    tglPembuatanLocalDate = tglPembuatanKTP.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
                    tglPembuatanFormatted = tglPembuatanLocalDate.format(DateTimeFormatter.ofPattern("dd-MM-yyyy"));
                }

                if (nikKTP.isEmpty() || namaOutput.isEmpty() ||  tempatLahirOutput.isEmpty() || tglLahirOutput == null || tanggalLahirlocalDateFormatted.isEmpty() ||
                        ...
                        tglPembuatanFormatted == null || fotoFile == null || ttdFile == null) {
                            System.out.println("Masuk ke pengecekan");
                    ...
                    Controller.PencarianController.cekInsert(KTP);
